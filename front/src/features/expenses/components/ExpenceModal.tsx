...
import {
  ModalType,
  useModalContext,
} from '@/features/expenses/contexts/ModalContext'
import ExpenseModalForm from '@/features/expenses/components/expenseModal/ExpenseModalForm'

const ExpenseModal = () => {
  const { isOpenModal, openModal, closeModal, modalType, modalRef } =
    useModalContext()
        ...
        <div className="sm:flex sm:items-start">
          <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
            <DialogTitle as="h2" className="text-lg weight-bold">
              {modalType === 'update' ? '支出を編集する' : '支出を登録する'}
            </DialogTitle>
            <div className="mt-2">
              <ExpenseModalForm />
            </div>
