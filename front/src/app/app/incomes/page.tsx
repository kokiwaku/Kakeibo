  ...
  return (
    <main className="flex flex-col gap-17 py-25 px-10">
      <div className="flex gap-10">
        ...
        <button className="bg-blue-500 text-white hover:bg-blue-200 rounded-md px-4 py-2 cursor-pointer">
          収入を追加
        </button>
      </div>
            ...
            >
              ...
              <td className="p-4">
                <div className="flex gap-2">
                  <button className="bg-gray-500 text-white hover:bg-gray-200 rounded-md px-4 py-2 cursor-pointer">
                    編集
                  </button>
                  <button className="bg-red-500 text-white hover:bg-red-200 rounded-md px-4 py-2 cursor-pointer">
                    削除
                  </button>
                </div>
              </td>
